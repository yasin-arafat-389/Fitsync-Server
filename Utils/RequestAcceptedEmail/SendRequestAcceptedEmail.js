...
const sendRequestAcceptedEmail = (to, subject, name) => {
        ...
        <section class="max-w-2xl px-6 py-8 mx-auto bg-white dark:bg-gray-900">
          ...
          <main class="mt-8">
            ...
            <p class="mt-2 leading-loose text-gray-600 dark:text-gray-300">
              Congratulations on becoming a trainer at
              <span class="font-semibold">FitSync</span>.
              <br/>
              We are looking forward to seeing you inspire our members achieve their fitness goal.
            </p>

            <a href='https://fitsync-be2e6.web.app/'>
            <button
...
module.exports = { sendRequestAcceptedEmail };
